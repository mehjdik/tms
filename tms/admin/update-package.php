...
$sql="update TblTourPackages set PackageName=:pname,PackageType=:ptype,PackageHotel=:photel,PackageLocation=:plocation,PackagePrice=:pprice,PackageFetures=:pfeatures,PackageDetails=:pdetails where PackageId=:pid";
...
<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packagehotel" id="packagehotel" placeholder="Hotel Name" value="<?php echo htmlentities($result->PackageHotel);?>" required>
									</div>
								</div>
